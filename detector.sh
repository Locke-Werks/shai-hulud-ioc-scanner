#!/usr/bin/env bash
#
# detector.sh — local-filesystem Shai-Hulud IOC scanner.
#
# Vendored from the upstream project "shai-hulud-detect" by @Cobenian:
#     https://github.com/Cobenian/shai-hulud-detect
# Licensed under the MIT License, Copyright (c) 2025 @Cobenian.
# See the LICENSE file in this repository for the full notice.
#
...
# Usage: ./detector.sh <directory_to_scan>
#
# Requires: Bash 5.0+
